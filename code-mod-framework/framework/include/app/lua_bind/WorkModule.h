...
namespace app::lua_bind {
    namespace WorkModule {
        ...
        float get_param_float(u64,u64 param_type,u64 param_hash) asm("_ZN3app8lua_bind32WorkModule__get_param_float_implEPNS_26BattleObjectModuleAccessorEmm") LINKABLE;
        int get_param_int(u64,u64 param_type,u64 param_hash) asm("_ZN3app8lua_bind30WorkModule__get_param_int_implEPNS_26BattleObjectModuleAccessorEmm") LINKABLE;
